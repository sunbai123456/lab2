...
<table class="table">
   ...
   <s:iterator value="titles" var="title">
     <s:url action="bookdetail" var="bookdetailUrl">
   		<s:param name="bookname" value="title" />
   </s:url>
   <s:url action="Delete"  var="DeleteUrl">
    ...
    <tr>
   <td><a href="<s:property value='bookdetailUrl'/>"><s:property /></a></td>
   <td><a href="<s:property value ='updateUrl'/>">更新</a></td>
   <td><a href="<s:property value='DeleteUrl'/>" onclick="return confirm('确定删除？')">删除</a></td>
<%--    <td><a href="/lab2/Delete?bookname=<s:property />&authorname=<s:property value='authorname'/>" onclick="return confirm('确定删除？')">删除</a></td> --%>
    </tr>
   </s:iterator>	
